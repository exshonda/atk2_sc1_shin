...
/*
 *  NUCLEO-H563ZI ボードサポートヘッダ（TOPPERS ATK2用）
 */
 ...
 *  ターゲット名（バナーで表示）
 */
#define TARGET_NAME     "NUCLEO-H563ZI(ARM Cortex-M33)"

/*
 *  コアのクロック周波数 (HSE=8MHz, PLL1 M=4/N=250/P=2 → 250MHz)
 */
#define CPU_CLOCK_HZ    250000000U

/*
 *  USART3 関連定義 (PD8=TX, PD9=RX, AF7)
 *  NUCLEO-H563ZI の ST-LINK VCP に接続
 */
